                                          ...
                                          onPressed: () {
                                            showDialog(
                                              ...
                                              builder: (BuildContext context) {
                                                return TopUpDialog(docId: docId!);
                                              },
                                            );
                                          },
                                        ),
                                      ...
                                      ListView.builder(
                                        ...
                                        itemBuilder: ((context, index) {
                                          ...
                                          return ListTile(
                                            ...
                                            title: Text(
                                              history['description'],
                                              style: TextStyle(color: setting.backgroundColor),
                                            ),
                                            subtitle: Text(
                                              history['timestamp'] != null ? formatTimestamp(history['timestamp']) : '',
                                              style: TextStyle(color: setting.backgroundColor),
                                            ),
                                            trailing: Text(
                                              '${history['type'] == 'credit' ? '+' : '-'} IDR ${history['amount']}',
                                              style: TextStyle(color: history['type'] =='credit'? Colors.green : Colors.red,
                                              ),
                                            )
                                          );
                                        }),
