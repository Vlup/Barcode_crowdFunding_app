                  ...
                  if (snapshot.hasData) {
                    ...
                    return Column(
                      children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: IconButton(
                                        icon: Icon(Icons.arrow_upward, color: Colors.green.shade700),
                                        onPressed: () {},
                                      ),
                                    ),
                                  ),
                        ...
                        StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance.collection('wallet_histories').where('userId', isEqualTo: docId).snapshots(),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Icon(Icons.history_edu, color: setting.backgroundColor),
                                      ),
                                  ...
                                  ListView.builder(
                                    ...
                                    itemBuilder: ((context, index) {
                                      final history = historyData[index].data() as Map<String, dynamic>;
                                      return ListTile(
                                        leading: Icon(
                                          history['type'] == 'debit' ? Icons.stacked_line_chart : Icons.monetization_on_outlined,
                                          color: history['type'] == 'debit' ? Colors.red : Colors.green,
                                        ),
                                        title: Text(history['description'], style: TextStyle(color: setting.backgroundColor),),
                                        subtitle: Text(_formatTimestamp(history['timestamp']), style: TextStyle(color: setting.backgroundColor),),
                                        trailing: Text(
